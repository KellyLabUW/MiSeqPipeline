...
#noprimerfolder = paste0("/Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA_LOCAL/Output/cutadapt_output/run",run.num,"_","20220428", "/noprimers/", marker)
...
metadata = "/Users/elizabethandruszkiewicz/GoogleDrive/UW/GitHub/NextGenNEPA_LOCAL/Output/cutadapt_output/run12_2_20221010/noprimers/MiFish/cutadapt_output_metadata_MiFish.csv"
...
# Locus_MiFish_NGN1176_S11_L001_R1_001.fastq
# Locus_MiFish_NGN1195_S30_L001_R1_001.fastq

sample.metadata <- sample.metadata[-11,]
sample.metadata <- sample.metadata[-29,]


## CHANGE TRIMMING LENGTHS IF YOU NEED TO AFTER LOOKING AT Q SCORE PLOT - REQUIRES HUMAN INPUT
#trimming.length.Read1 = 225
trimming.length.Read1 = 130
...
sample.metadata %>%
  ...
  mutate (outFs = pmap(.l= list (file1, filtF1, file2, filtR1),
          ...
          dadaF1  = map2(derepF1,errF1, ~ dada(.x, err = .y, multithread = TRUE, pool=TRUE)),  # dada2
          dadaR1  = map2(derepR1,errR1, ~ dada(.x, err = .y, multithread = TRUE, pool=TRUE)),
